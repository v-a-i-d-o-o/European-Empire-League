...
European Empire League Constitution #
The constitution of the European Empire League Fantasy Dynasty League
...
The commissioner will take no % of any entry fees.
...
IR	3	No Limit
Taxi spots 5
Immediately following the Championship game, rosters will expand to give teams 25 bench spots to accomodate incoming rookies/free agents for the following season.
Following the 3rd preseason NFL game, bench spots will be returned to the standard size of 15, so managers must make the required cuts to allow for this. The exact date/time of the cut deadline will be posted in league chat.
...
Each team will receive $100 for a Free Agency Aquisition Budget at the start of week 1 of the NFL season.
Minimum bid to get a FA off waivers is $0
FAAB dollars are tradeable however they will not roll over to next season.
Waivers will process on Tuesdays and Saturdays.
...
When free agency/waivers recommence following the rookie draft, each team will receive their season FAAB of $100, there is no separate off-season FAAB.
...
Trade deadline is at the end of week 12 (check Sleeper for details).
...
Players available to draft will be sorted alphabetically rather than ADP.

Will commence July 1st 2022 on Sleeper, or earlier if all fees are paid.
Draft order will be randomized three times using the Sleeper randomiser which posts the draft order automatically after randomisation.
Startup draft will be a combined rookie/vets draft.
Snake format (1st to 12th then 12th to 1st).
Each day the draft will last from 8AM to 10PM BST with each team having 8 hours per pick. The draft will be paused outside of these hours. Managers should endeavour to make their picks as soon as possible.
...
Each day the draft will last from 8AM to 10PM BST with each team having 8 hours per pick.
...
The next four teams (3/4/5/6) will be assigned their playoff seeding spot based on regular season record.

Consolation Bracket
Seeding will be determined by end of regular season standing for the 6 teams not in the Championship Bracket.
The teams 7/8 in the standings will be assigned the top two seeds, and will receive a by in the first week of the consolation playoffs.
The next four teams (9/10/11/12) will be assigned their playoff seeding spot based on regular season record.
These teams will compete to try to win the consolation bracket.
The consolation bracket has no bearing on draft order, there's £15 up for grabs for the winner however and obviously some pride as well.



Section X - Scoring
Scoring can be seen in the League settings page of the app/website and is a little different to usual scoring settings. It is an adjusted PPR league.
...
European-Super-League-Constitution is maintained by Vaidooo.
